...
export const createTableContext = () =>
  create<{
    ...
    getTableObjects: (tableListId: string) => TableObjectType[] | null;
    createNewTableObject: (tableListId: string) => void;
    updateTableObjectTitle: (tableListId: string, tableObjectId: string, newTitle: string) => void;
    updateColumnTitle: (tableListId: string, tableObjectId: string, colId: string, newTitle: string) => void;
    updateCell: (tableListId: string, tableObjectId: string, rowId: string, colId: string, value: string) => void;
    addColumn: (tableListId: string, tableObjectId: string) => void;
    addRow: (tableListId: string, tableObjectId: string) => void;
    deleteRow : (tableListId : string, tableObjectId : string, rowId : string) => void;
    deleteColumn : (tableListId : string, tableObjectId : string, colId : string) => void
  }>((set, get) => ({
    tables: [],
